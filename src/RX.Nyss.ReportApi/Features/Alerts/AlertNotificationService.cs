    ...
    public async Task SendNotificationsForNewAlert(Alert alert, GatewaySetting gatewaySetting)
    {
        ...
        switch (gatewaySetting.GatewayType)
        {
            ...
            case GatewayType.SmsGateway:
                ...
                break;
            case GatewayType.MTNSmsGateway:
                await _queuePublisherService.SendMTNGatewayHttpSms(_recipients, gatewaySetting, message);
                break;
    ...
    public async Task SendNotificationsForSupervisorsAddedToExistingAlert(Alert alert, List<SupervisorSmsRecipient> supervisors, GatewaySetting gatewaySetting)
    {
        ...
        switch (gatewaySetting.GatewayType)
        {
            ...
            case GatewayType.SmsGateway:
                ...
                break;
            case GatewayType.MTNSmsGateway:
                await _queuePublisherService.SendMTNGatewayHttpSms(_phoneNumbers, gatewaySetting, message);
                break;
            case GatewayType.Unknown:
                _loggerAdapter.Info("Could not find proper gateway!");
                break;
