...
{
    public class CreateHeadSupervisorRequestDto
    {
        ...
        public class CreateHeadSupervisorValidator : AbstractValidator<CreateHeadSupervisorRequestDto>
        {
            public CreateHeadSupervisorValidator(IOrganizationService organizationService, IProjectAccessService projectAccessService)
            {
